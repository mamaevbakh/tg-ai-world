...
const objects: SeedObject[] = [
  ...
  { key: "loose_fuse", locationKey: "utility_wall", name: "Loose Fuse", type: "machine_part", description: "A fuse sitting loose inside the opened utility panel.", state: { seated: false, visible_after: "utility_panel.opened" }, usable: true, durability: 45 },
